/decl/hierarchy/outfit/job/security
	...
	shoes = /obj/item/clothing/shoes/leatherboots
...
/decl/hierarchy/outfit/job/security/hos
	name = OUTFIT_JOB_NAME("Hand of the King")
	l_ear = /obj/item/device/radio/headset/heads/hos
	uniform = /obj/item/clothing/under/medieval/knight
	id_type = /obj/item/weapon/card/id/security/head
	pda_type = /obj/item/device/pda/heads/hos
	backpack_contents = list(/obj/item/weapon/handcuffs = 1)

/decl/hierarchy/outfit/job/security/warden
	name = OUTFIT_JOB_NAME("Jailer")
	uniform = /obj/item/clothing/under/medieval/knight
	id_type = /obj/item/weapon/card/id/security/warden

/decl/hierarchy/outfit/job/security/detective	//kil this later
